...
puts "ACTUAL PROJECTION CENTROID: #{polygon.projection.centroid.inspect}"
...
raise "INVALID CENTROID" unless polygon.projection.centroid == expected_centroid.projection
puts "polygon.projection.centroid == expected_centroid.projection TEST PASSED"
